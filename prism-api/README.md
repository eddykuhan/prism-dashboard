# Prism Developers Dashboard API

A unified developer dashboard backend built with .NET 10. Receives OpenTelemetry data (traces, metrics, logs) via OTLP, integrates with Kubernetes APIs, ServiceNow incidents, and GitHub pull requests. Provides real-time streaming via WebSocket and REST APIs for dashboard visualization.
