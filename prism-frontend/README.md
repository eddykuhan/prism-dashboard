# Prism Developers Dashboard - Frontend

A modern Angular 18 Single Page Application providing a unified developer dashboard with real-time OpenTelemetry data, Kubernetes pod monitoring, ServiceNow incidents, and GitHub pull requests, plus integrated AI-powered debugging via Azure OpenAI.
